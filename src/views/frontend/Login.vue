  ...
  <div class="position-relative h_100vh">
    ...
    <div class="row mt-5 mt-xl-9">
      ...
      d-flex align-items-center justify-content-end text-white text_xl_black">
        ...
        bg_xl_transparent w-100 w-xl-75 p-3 mx-2 my-5 m-lg-5 m-lg-0">
...
<style lang="scss">
.bgLoginImg{
  background: url(https://hexschool-api.s3.us-west-2.amazonaws.com/custom/Ze1hQaqBBL5k7TpD8XBXLBRLzvgCgSHaFg74LSugBfvQHEmjDZL5t1KtcfV44lk646DA3ArvpHxLElmPTDfh4Cew5loG4ACydAb22TbvVAHZCk2jE878HdE3SwfbTXt4.jpg) no-repeat;
  width: 100%;
  top: 0;
  bottom: 0;
